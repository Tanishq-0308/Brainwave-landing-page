...
const Hero = () => {
  ...
  return (
    <>
      <main className='w-full h-[85vh] heroImage mt-[85px] absolute'>
        <div className='bg-black opacity-55 h-full w-full absolute'>
        </div>
        <div className='relative flex flex-col gap-15 items-center justify-center h-full '>
          <div className='relative'>
            <h1 className='text-white text-4xl p-4 cursor-pointer sm:text-6xl font-bold text-center tracking-wide pb-15'>
            ...
            <p className='text-[#f1f1f1] head text-[20px] sm:text-[20px] text-center'>
